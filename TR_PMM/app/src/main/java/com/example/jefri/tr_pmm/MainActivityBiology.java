...
public class MainActivityBiology extends ListActivity {
    ...
    private static String url = "http://archive.org/advancedsearch.php?q=Biology%20video&fl[]=description&fl[]=downloads&fl[]=identifier&fl[]=mediatype&fl[]=title&sort[]=&sort[]=&sort[]=&rows=10&page=1&indent=yes&output=json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_biology);
...
//                        Toast.LENGTH_SHORT).show();
    ...
    private class GetVideos extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(MainActivityBiology.this);
            ...
            if (jsonStr != null) {
                try {
                    ...
                    for (int i = 0; i < videos.length(); i++) {
                        ...
                        String title = "Unknown", duration = "", identifier = "Unknown";
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            adapter = new SimpleAdapter(
                    MainActivityBiology.this, videoList,
                    R.layout.listview,
                    new String[]{TAG_TITLE, TAG_DURATION, TAG_IDENTIFIER},
                    new int[]{R.id.text_size_video,
                            R.id.text_duration_video,
                            R.id.tv_identifier});

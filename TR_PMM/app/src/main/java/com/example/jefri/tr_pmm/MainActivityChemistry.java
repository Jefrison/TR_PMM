...
public class MainActivityChemistry extends ListActivity {
    ...
    private static String url = "http://archive.org/advancedsearch.php?q=chemistry%20video&fl[]=description&fl[]=downloads&fl[]=identifier&fl[]=mediatype&fl[]=title&sort[]=&sort[]=&sort[]=&rows=10&page=1&indent=yes&output=json";
...
//                        Toast.LENGTH_SHORT).show();
    ...
    private class GetVideos extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            pDialog = new ProgressDialog(MainActivityChemistry.this);
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            adapter = new SimpleAdapter(
                    MainActivityChemistry.this, videoList,
                    R.layout.listview,

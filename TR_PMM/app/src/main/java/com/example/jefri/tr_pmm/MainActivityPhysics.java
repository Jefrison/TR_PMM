...
public class MainActivityPhysics extends ListActivity {
    ...
    private static String url = "http://archive.org/advancedsearch.php?q=physics%20video&fl[]=description&fl[]=downloads&fl[]=identifier&fl[]=mediatype&fl[]=title&sort[]=&sort[]=&sort[]=&rows=10&page=1&indent=yes&output=json";
